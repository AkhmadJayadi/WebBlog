...
//Route::get('/dashboard/slider/edit/', [FooterController::class, 'edit'])->middleware('auth');
...
//Route::get('dashboard/slider/{id}', [ImageSliderController::class, 'haii'])->name('track.progress')->middleware('guest');
Route::resource('/dashboard/slider', ImageSliderController::class)->middleware('auth');

//Route::post('kirimwa', 'Contact@sendwa');
