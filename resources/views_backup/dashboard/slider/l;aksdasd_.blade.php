...
<div class="col-lg-8">
    <form method="post" action="/dashboard/slider" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control  @error('label') is-invalid @enderror" id="label" name="label" required autofocus value="{{ old('label') }}">
          @error('label')
...
<script>
    ...
    title.addEventListener('change', function(){
        fetch('/dashboard/slider/checkSlug?title='+title.value)
