      ...
      <div class="container">
        ...
        <div class="col text-center">
          ...
          <div class="row text-end">
            ...
            <div class="col-1"><p>{{ $post2->nohp }}</p></div>
          </div>
          <div class="row text-end">
            <div class="col-5">
              <i class="fa fa-whatsapp fa-2x" aria-hidden="true"></i>
            </div>
            <div class="col-1"><p>{{ $post2->whatsapp }}</p></div>
          </div>
          <div class="row text-end">
            <div class="col-5">
              <i class="fa fa-envelope fa-2x" aria-hidden="true"></i>
            </div>
            <div class="col-1"><p>{{ $post2->email }}</p></div>
          </div>
          <div class="row text-end">
            <div class="col-5">
              <i class="fa fa-instagram fa-2x" aria-hidden="true"></i>
            </div>
            <div class="col-1"><p>{{ $post2->instagram }}</p></div>
          </div>
        </div>
      </div>
      </div>
